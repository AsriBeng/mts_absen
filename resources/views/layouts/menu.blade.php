...
<nav class="px-3 space-y-1">
    @if ($roleName === 'admin')
        ...
        <a href="{{ url('/admin/absensi') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition {{ request()->is('admin/absensi*') ? 'bg-emerald-600 text-white shadow-md' : 'text-emerald-100 hover:bg-emerald-800/60 hover:text-white' }}">
        ...
        <a href="{{ url('/admin/rekap') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition {{ request()->is('admin/rekap*') ? 'bg-emerald-600 text-white shadow-md' : 'text-emerald-100 hover:bg-emerald-800/60 hover:text-white' }}">
        ...
        <a href="{{ url('/admin/days') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition {{ request()->is('admin/days*') ? 'bg-emerald-600 text-white shadow-md' : 'text-emerald-100 hover:bg-emerald-800/60 hover:text-white' }}">
        ...
        <a href="{{ url('/admin/users-setting') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition {{ request()->is('admin/users-setting*') ? 'bg-emerald-600 text-white shadow-md' : 'text-emerald-100 hover:bg-emerald-800/60 hover:text-white' }}">
    ...
    @else
        ...
        <a href="{{ url('/guru/absen-saya') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition {{ request()->is('guru/absen-saya*') ? 'bg-emerald-600 text-white shadow-md' : 'text-emerald-100 hover:bg-emerald-800/60 hover:text-white' }}">
            <i class="fas fa-file-alt text-lg w-6 text-center shrink-0"></i>
